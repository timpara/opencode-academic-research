...
[![Version](https://img.shields.io/badge/version-v3.13.0--opencode.1-blue)](https://github.com/timpara/opencode-academic-research/releases)
...
| `/ars-3w` | deep-research | three-way-scan | WHY / HOW / WHAT paper comparison |
| `/ars-rebuttal-audit` | academic-paper | rebuttal-audit | QA an existing rebuttal draft against reviewer comments |
| `/ars-cache-invalidate` | academic-paper | n/a | Drop cached verification entries for a citation key |
...
Agent-per-agent responsibilities and stage-by-stage artifacts have been moved to [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md). Version numbers are anchored here to keep release metadata in one place.
...
**[cloudenochcsis](https://github.com/cloudenochcsis)** — Upstream contributor. Extended the IS section from the *Basket of 8* to the full *Senior Scholars' Basket of 11* — adding *Decision Support Systems*, *Information & Management*, and *Information and Organization* ([Issue #7](https://github.com/Imbad0202/academic-research-skills/issues/7), [PR #8](https://github.com/Imbad0202/academic-research-skills/pull/8)). Sourced from the [AIS Senior Scholars' List of Premier Journals](https://aisnet.org/research/seniorscholarsbasket/).
